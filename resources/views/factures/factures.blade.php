        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <a href="{{ route('factures.create') }}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                            class="fas fa-plus"></i>&nbsp; Ajouter une facture</a>



                    <a class="modal-effect btn btn-sm btn-primary" href="" style="color:white"><i
                            class="fas fa-file-download"></i>&nbsp;Exporter EXCEL</a>
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Num Facture</th>
                                    ...
                                    <th class="border-bottom-0">Valeur TVA</th>
                                    <th class="border-bottom-0">Totale</th>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item" href="#"
                                                            data-invoice_id="" data-toggle="modal"
